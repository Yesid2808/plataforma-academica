...
IS_RENDER = os.getenv('RENDER', '').strip().lower() == 'true' or bool(os.getenv('RENDER_EXTERNAL_HOSTNAME'))
...
APP_ENV = config('APP_ENV', default='production' if IS_RENDER else 'local')
DEBUG = env_bool('DEBUG', default=(APP_ENV == 'local' and not IS_RENDER))
